...
var msg1 = "Warning";
var msg2 = "";
var msg_html = "<br clear=all><p><b>BG</b>: Уеб приложението не е съвместимо с версията на уеб браузъра, която използвате. Възможно е някои функции да не работят, както се очаква. За да подобрите изпълнението, обновете версията на браузъра или използвайте друг браузър, например Google Chrome, Mozilla Firefox или Safari.</p>" +
"<p><b>CS</b>: Tato webová aplikace není kompatibilní s verzí prohlížeče, kterou používáte. Některé prvky nemusí fungovat tak, jak byly navrženy. Za účelem zajištění optimální funkčnosti prosím upgradujte na novější verzi nebo použijte jiný prohlížeč, například Chrome, Firefox nebo Safari.</p>"+
"<p><b>DA</b>: Denne webapplikation er ikke kompatibel med den webbrowserversion, du anvender. Visse elementer funger måske ikke efter hensigten. For bedre at kunne udnytte anvendelsesmulighederne bør du opgradere til en nyere version eller anvende en anden browser, for eksempel Crome, Firefox eller Safari.</p>"+
"<p><b>DE</b>: Diese Web-Anwendung ist mit der von Ihnen verwendeten Webbrowser-Version nicht kompatibel. Manche Funktionen funktionieren möglicherweise nicht wie vorgesehen. Um Ihre Nutzungsmöglichkeiten zu verbessern, empfehlen wir, zu einer neueren Version zu wechseln oder einen anderen Browser (z. B. Chrome, Firefox oder Safari) zu verwenden.</p>"+
"<p><b>EL</b>: Αυτή η διαδικτυακή εφαρμογή δεν είναι συμβατή με την έκδοση του περιηγητή που χρησιμοποιείτε. Ορισμένες εφαρμογές ενδέχεται να μην λειτουργούν όπως είχαν σχεδιαστεί. Για καλύτερη απόδοση, αναβαθμίστε τον περιηγητή σας στην πιο πρόσφατη έκδοση ή χρησιμοποιήστε κάποιον εναλλακτικό περιηγητή όπως Crome, Firefox ή Safari.</p>"+
"<p><b>ES</b>: Esta aplicación para la Web no es compatible con la versión del navegador que está utilizando. Algunas características pueden no funcionar según lo previsto. Para mejorar su uso de la aplicación, le aconsejamos instalar una nueva versión o utilizar un navegador alternativo, como Crome, Firefox o Safari.</p>"+
"<p><b>ET</b>: See veebirakendus ei ühildu veebibrauseriga. Mõned funktsioonid ei pruugi täielikult toimida. Paremaks kasutamiseks uuenda versiooni või vali alternatiivne brauser, nt Chrome, Firefox või Safari.</p>"+
"<p><b>FI</b>: Tämä verkkosovellus ei ole yhteensopiva käyttämäsi verkkoselaimen version kanssa. Jotkin ominaisuudet eivät ehkä toimi kuten on suunniteltu. Parantaaksesi toimintaa päivitä selain uudempaan versioon tai käytä jotakin muuta selainta, esimerkiksi Cromea, Firefoxia tai Safaria.</p>"+
...
"<p><b>HU</b>: Ez a webes alkalmazás nem kompatibilis az Ön által használt webböngésző verziójával. Előfordulhat, hogy egyes funkciók nem a tervezettnek megfelelően működnek. Annak érdekében, hogy az eszközt a legoptimálisabb módon tudja használni, váltson az újabb verzióra vagy másik böngészőre, mint például a Chrome, a Firefox vagy a Safari.</p>"+
"<p><b>IS</b>: Þessi vefhugbúnaður er ekki samhæfður við vafraútgáfuna sem þú notar. Ekki er víst að allir eiginleikar virki eins og ætlast er til. Til þess að upplifun þín verði betri skaltu uppfæra í nýrri útgáfu eða nota annan vafra, svo sem Crome, Firefox eða Safari.</p>"+
"<p><b>IT</b>: Quest’applicazione web non è compatibile con la versione del browser che si sta usando. Alcune funzionalità potrebbero non funzionare come dovrebbero. Per migliorare la propria esperienza, si prega di aggiornare a una versione più recente o di usare un browser alternativo come Crome, Firefox o Safari.</p>"+
"<p><b>LT</b>: Ši interneto programa neveikia naudojant jūsų interneto naršyklės versiją. Kai kurios funkcijos gali neveikti. Kad programa veiktų geriau, atnaujinkite savo naršyklės versiją arba naudokitės kita naršykle, pvz., Chrome, Firefox arba Safari.</p>"+
"<p><b>LV</b>: Šī tīmekļa lietojumprogramma nav saderīga ar tīmekļa pārlūkprogrammas versiju, kuru Jūs izmantojat. Dažas funkcijas var nedarboties, kā paredzēts. Lai uzlabotu iespējas, lūdzam veikt jauninājumu uz jaunāku versiju vai izmantot citu pārlūkprogrammu, piemēram, Crome, Firefox vai Safari.</p>"+
"<p><b>MT</b>: Din l-applikazzjoni web mhix kumpatibbli mal-verżjoni tal-brawżer li qed tuża.. Xi funzjonijiet jistgħu ma jaħdmux kif suppost. Biex ittejjeb l-esperjenza tiegħek, jekk jogħġbok aġġorna għal verżjoni iżjed riċenti jew uża brawżer differenti bħal Crome, Firefox jew Safari.</p>"+
"<p><b>NL</b>: Deze webtoepassing is niet verenigbaar met de versie van de webbrowser die u gebruikt. Enkele functies werken wellicht niet als werd voorzien. Voer een upgrade uit naar een nieuwere versie of gebruik een andere browser, zoals Chrome, Firefox of Safari, om de mogelijkheden beter te kunnen benutten.</p>"+
"<p><b>NO</b>: Denne nettapplikasjonen er ikke kompatibel med den nettleserversjonen du bruker. Det kan hende at enkelte funksjoner ikke virker som de skal. For å forbedre opplevelsen bør du oppgradere til en nyere versjon eller bruke en annen nettleser, for eksempel Chrome, Firefox eller Safari.</p>"+
"<p><b>PL</b>: Niniejsza aplikacja internetowa nie jest kompatybilna z wersją stosowanej przeglądarki internetowej. Niektóre elementy mogą nie funkcjonować w zaplanowany sposób. Aby móc w pełni korzystać z dostępnych funkcji, należy zainstalować nowszą wersję programu lub inną przeglądarkę, tj. Chrome, Firefox czy Safari.</p>"+
"<p><b>PT</b>: Esta aplicação Web não é compatível com a versão do seu navegador de Internet. Algumas funções poderão não funcionar corretamente. Para melhorar a sua experiência, atualize o seu navegador para uma versão mais recente ou utilize outro navegador, como o Chrome, o Firefox ou o Safari.</p>"+
"<p><b>RO</b>: Această aplicaţie web nu este compatibilă cu versiunea browserului web pe care-l folosiţi. Unele caracteristici s-ar putea să nu funcţioneze la parametrii prevăzuţi. Pentru o mai bună utilizare a aplicaţiei, vă rugăm să actualizaţi versiunea sau să folosiţi alt browser, de exemplu Chrome, Firefox sau Safari.</p>"+
"<p><b>SK</b>: Táto webová aplikácia nie je kompatibilná s verziou prehliadača, ktorú používate. Môže sa stať, že niektoré funkcie nebudú fungovať tak, ako majú. Za účelom zaistenia optimálnej funkčnosti, inštalujte si najnovšiu verziu alebo použite iný prehliadač, ako napr. Chrome, Firefox alebo Safari.</p>"+
"<p><b>SL</b>: Ta spletna aplikacija ni združljiva z različico spletnega brskalnika, ki jo uporabljate. Nekatere njene funkcije zato morda ne bodo delovale, kot so bile zasnovane. Za boljši ogled si naložite novejšo različico brskalnika ali pa uporabite drug brskalnik, kot je denimo Chrome, Firefox ali Safari.</p>"+
"<p><b>SV</b>: Denna webbapplikation är inte kompatibel med den webbläsare du använder. Vissa funktioner fungerar kanske inte som tänkt. Uppgradera till en nyare version eller använd en annan webbläsare, t.ex. Crome, Firefox eller Safari, för att förbättra upplevelsen.</p>"+
"";
