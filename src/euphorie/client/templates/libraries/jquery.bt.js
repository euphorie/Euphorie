      ...
      this.btOn = function () {
        ...
        if (opts.ajaxPath != null && content == false) {
          ...
          if (typeof cacheData == 'string') {
            ...
            // do the ajax request
	    // Add a small delay to make sure the AJAX content can not come in before the
	    // ajaxLoading tooltip is fully ready. Otherwise we get a nasty race.
	    setTimeout(function() { jQuery.ajax(ajaxOpts); }, 100);
