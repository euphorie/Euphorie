/**
 * Patterns bundle v1.1.0-759688a1
 *
...
// jshint indent: 4, browser: true, jquery: true, quotmark: double
// vim: sw=4 expandtab
;require(['registry', "modernizer", "pat/collapsible", "pat/depends", "pat/legend", "pat/modal", "pat/placeholder", "pat/tooltip"], function(r){r.init();});