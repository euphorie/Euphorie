/**
 * Patterns bundle v1.1.0-1-g809dd9c-d182214a
 *
...
define('modernizer', ['modernizer/modernizr-development'], function (main) { return main; });

define("modernizer/modernizr-development", function(){});
...
// jshint indent: 4, browser: true, jquery: true, quotmark: double
// vim: sw=4 expandtab
;require(['registry', "modernizer", "pat/autofocus", "pat/collapsible", "pat/depends", "pat/legend", "pat/modal", "pat/placeholder", "pat/tooltip"], function(r){r.init();});