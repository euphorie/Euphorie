...
class WebHelpers(BrowserView):
    ...
    def extra_css(self):
        ...
        if main_background and main_foreground and support_background and support_foreground:
            ...
            parts.append("brightMainColour" if sector.main_background_bright else "darkMainColour")
            parts.append("brightSupportColour" if sector.support_background_bright else "darkSupportColour")
