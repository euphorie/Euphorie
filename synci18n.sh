...
# Rebuild .pot
i18ndude rebuild-pot --exclude="generated prototype examples" --pot locales/$CATALOGNAME.pot --merge locales/manual.pot --create $CATALOGNAME src/euphorie
